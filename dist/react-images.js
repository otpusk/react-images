	...
	createClass(Video, [{
		...
		value: function render$$1() {
			...
			return React__default.createElement(
				...
				React__default.createElement('div', { ref: this.node, style: STYLES.IFRAME })
			);
		}
	}]);
	return Video;
...
var Lightbox = function (_Component) {
	...
	createClass(Lightbox, [{
		...
		value: function renderImages() {
			...
			switch (object.type) {
				case 'video':
					return React__default.createElement(Video, { id: object.id, provider: object.provider, className: aphrodite.css(this.classes.figure) });
				default:
					return React__default.createElement(
						'figure',
